...
Press it again to stop immediately, without waiting for the suite or the corpus. A `SIGTERM` is
passed on to the suite and then handled the same way, exiting `143`.
